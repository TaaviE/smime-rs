...
mod tests {
    ...
    fn test_hash_algorithm_rejection() {
        ...
        let p256_key =
            smime::AnyPublicKey::P256 { algorithm: smime::cryptography_x509::oid::EC_OID, spki_der: P256_TEST_SPKI_DER.to_vec() };
    ...
    fn test_hash_algorithm_accepted() {
        ...
        for (key, label) in [
            ...
            (
                smime::AnyPublicKey::P384 { algorithm: smime::cryptography_x509::oid::EC_OID, spki_der: P384_TEST_SPKI_DER.to_vec() },
                "P-384",
            ),
            (
                smime::AnyPublicKey::P521 { algorithm: smime::cryptography_x509::oid::EC_OID, spki_der: P521_TEST_SPKI_DER.to_vec() },
                "P-521",
            ),
        ] {
            for hash in [HashType::SHA256, HashType::SHA384, HashType::SHA512, HashType::SHA3_256, HashType::SHA3_384, HashType::SHA3_512] {
